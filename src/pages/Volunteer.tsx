      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {activeTab === 'info' ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h1 className="text-4xl font-bold text-brand-dark mb-6 font-serif">
                  ...
                  <CardContent className="p-0 flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-600">
                        Gain hands-on experience performing ABI tests and patient histories under
                        vascular surgeon supervision.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-none bg-transparent">
                  <CardContent className="p-0 flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-600">
                        Access our digital library of protocols, Doppler usage guides, and patient
                        education scripts.
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card className="border-none shadow-none bg-transparent">
                  <CardContent className="p-0 flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-600">
                        Sign up for 4-hour shifts at pop-up clinics that fit your rotation schedule.
                      </p>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card className="mt-10 bg-slate-100 border-slate-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-slate-600 text-sm mb-4">
                    Are you a barbershop, church, or community center looking to host an event?
                  </p>
                  <Button variant="link" className="text-brand-red font-bold px-0 underline">
                    Request Host Information Packet
                  </Button>
                </CardContent>
              </Card>
            </div>
                ...
                <form className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-slate-700">
                      Email (Use .edu if student)
                    </Label>
                    <Input id="email" type="email" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="affiliation" className="text-slate-700">
                  ...
                  <Button
                    type="button"
                    className="w-full bg-brand-red hover:bg-red-800 font-bold py-6 text-lg mt-4"
                  >
                    Submit Application
                  </Button>
            ...
            <Card className="shadow-lg">
              <CardContent className="p-8">
                ...
                <form className="space-y-4">
                  ...
                  <Button
                    type="button"
                    className="w-full bg-brand-dark hover:bg-slate-800 font-bold py-6"
                  >
                    Log In
                  </Button>
                  <div className="text-center mt-4">
                    <Button
                      variant="link"
                      onClick={() => setActiveTab('info')}
                      className="text-sm text-brand-red h-auto p-0"
                    >
