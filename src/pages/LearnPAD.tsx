        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            ...
            <p className="text-xl text-slate-600 leading-relaxed mb-8">
              Peripheral artery disease (PAD) is a common condition where narrowed arteries reduce
              blood flow to the limbs. It typically affects the legs, causing pain when walking
              (claudication).
            </p>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-12 rounded-r-lg">
              ...
              <ul className="space-y-2 text-blue-800">
                <li className="flex items-start">
                  ...
                  PAD is often caused by a buildup of fatty deposits in the arteries
                  (atherosclerosis).
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
            ...
            <div id="overview" className="mb-12 scroll-mt-24">
              <h2 className="text-3xl font-bold text-brand-dark mb-4 border-b pb-2 font-serif">
                Overview
              </h2>
              <p className="text-slate-700 mb-4 leading-7">
                Just as your heart arteries can get clogged, the arteries in your legs can too. This
                condition is called Peripheral Artery Disease (PAD). It occurs when plaque (fat and
                cholesterol) builds up in the arteries that supply blood to your limbs.
              </p>
              <p className="text-slate-700 mb-6 leading-7">
                Over time, this plaque can harden and narrow your arteries. This limits the flow of
            ...
            <div id="symptoms" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-700 mb-4">
                Many people with mild PAD have no symptoms. However, the most common symptom is
                muscle pain or cramping in your legs or arms that is triggered by activity, such as
                walking, but disappears after a few minutes of rest. This is known as{' '}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <Card>
                  <CardContent className="p-5">
                    ...
                    <p className="text-sm text-slate-600">
                      Shiny skin on your legs, hair loss or slower hair growth on your feet and
                      legs.
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-5">
                    ...
                    <p className="text-sm text-slate-600">
                      Coldness in your lower leg or foot, especially when compared with the other
                      side.
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-5">
                    ...
                    <p className="text-sm text-slate-600">
                      Sores on your toes, feet or legs that won't heal or take a very long time to
                      heal.
                    </p>
                  </CardContent>
                </Card>
            ...
            <div id="risk-factors" className="mb-12 scroll-mt-24">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700 marker:text-brand-red">
                <li>
                  <strong>Smoking:</strong> This is the single biggest risk factor for PAD.
                </li>
                <li>
                  <strong>Diabetes:</strong> High blood sugar can damage your arteries over time.
                </li>
                <li>
                  <strong>Age:</strong> Risk increases significantly after age 50.
                </li>
                <li>
                  <strong>High Blood Pressure:</strong> Increases the force of blood against your
                  artery walls.
                </li>
                <li>
                  <strong>High Cholesterol:</strong> Contributes to the buildup of plaques.
                </li>
              </ul>
            </div>
            ...
            <Card id="diagnosis" className="bg-slate-50 border-slate-200">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 mb-6">
                  If you have leg pain, numbness or other symptoms, don't dismiss them as a normal
                  part of aging. Call your doctor and ask about PAD.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button asChild className="bg-brand-red hover:bg-red-800 text-white font-bold">
                    <Link to="/screenings">Find a Screening Event</Link>
                  </Button>
                  <Button
                    asChild
                    variant="outline"
                  ...
                  >
                    <Link to="/quiz">Take Risk Assessment</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="sticky top-24 space-y-8">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold text-brand-dark mb-4 uppercase tracking-wider text-xs">
                    On This Page
                  </h3>
                  <nav className="space-y-1">
                    <Button
                      ...
                      className="w-full justify-start text-slate-600 h-auto py-2 px-2 hover:text-brand-red hover:underline"
                    >
                      Overview
                    </Button>
                    <Button
              ...
              <Card className="bg-brand-dark border-none text-white shadow-lg">
                <CardContent className="p-6">
                  ...
                  <Button asChild className="w-full bg-brand-red hover:bg-red-700 font-bold">
                    <Link to="/screenings">Find a Location</Link>
                  </Button>
