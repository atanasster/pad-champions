          ...
          <Card className="max-w-md w-full animate-in zoom-in-95">
            <CardContent className="p-6">
              ...
              <p className="text-slate-600 mb-6 text-lg">
                ...
                <span className="font-bold text-slate-900">{eventToDelete.name}</span>?
              ...
              <div className="flex justify-end gap-3">
                <Button variant="ghost" onClick={() => setEventToDelete(null)}>
                  Cancel
                </Button>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-lg text-slate-700">Browse upcoming screenings by date.</p>
          </div>
          <Button
          ...
          >
            {isFormOpen ? (
              <>
                <X className="w-5 h-5 mr-2" /> Close Admin Mode
              </>
            ) : (
              <>
                <Plus className="w-5 h-5 mr-2" /> Admin / Add Event
              </>
            )}
          </Button>
        </div>
        ...
        <div className="flex flex-wrap gap-4 mb-6 text-sm text-slate-600">
          <div className="flex items-center">
            <div className="w-3 h-3 rounded-full bg-red-600 mr-2"></div> Barbershop
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 rounded-full bg-indigo-600 mr-2"></div> Church
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 rounded-full bg-emerald-600 mr-2"></div> Pharmacy
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 rounded-full bg-amber-600 mr-2"></div> Community Center
          </div>
        </div>
              ...
              <form onSubmit={handleAddEvent}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="space-y-2">
                    <Label htmlFor="event-name" className="text-slate-700">
                      Event Name
                    </Label>
                    <Input
                      id="event-name"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="venue-name" className="text-slate-700">
                      Venue Name
                    </Label>
                    <Input
                      id="venue-name"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="event-time" className="text-slate-700">
                      Time
                    </Label>
                    <Input
                      id="event-time"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="venue-type" className="text-slate-700">
                      Venue Type
                    </Label>
                    <Select
                      value={formData.type}
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <Button type="submit" className="bg-brand-red hover:bg-red-800">
          ...
          {selectedDateLabel ? (
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-8 text-center text-slate-600">
              <p className="text-lg font-medium">
                Select a date or event on the calendar above to view details.
              </p>
            </div>
          )}
        </div>
...
const EventCard: React.FC<EventCardProps> = ({ event, isAdmin, onDelete }) => {
  ...
  return (
    <Card
      className={`border-l-4 overflow-hidden relative group hover:shadow-md transition-shadow`}
    ...
    >
      <CardContent className="p-6 flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <div className="mb-4 md:mb-0">
          <span
            className={`inline-flex items-center px-2 py-1 ${style.lightBg} ${style.text} text-xs font-bold uppercase tracking-wide rounded mb-2`}
          >
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
          <Button asChild className="bg-brand-dark hover:bg-slate-800">
            <a
