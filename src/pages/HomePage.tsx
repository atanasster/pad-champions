          ...
          <div className="flex flex-col md:flex-row items-center gap-12 px-4 md:px-12">
            ...
            <div className="md:w-1/2 flex justify-center">
               <div className="relative w-64 h-64 bg-slate-100 rounded-full flex items-center justify-center p-4 shadow-inner">
                  ...
                  <img src="/screening.png" className="w-full h-full object-cover rounded-full opacity-90" alt="Leg Arteries Illustration" />
               ...
               <ul className="space-y-3 flex-grow">
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-center">
                   <div className="flex flex-col items-center text-center">
                     <img src="/img/logo.png" className="h-16 w-auto mb-2 opacity-80" alt="CHAMPIONS Small" />
                     <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">Scientific Standards</p>
                   </div>
                </div>
             </div>
                ...
                <div className="border-2 border-slate-200 rounded-xl p-5 hover:border-brand-red transition-colors bg-white">
                  ...
                  <p className="text-slate-700 font-medium mb-2">
                   ...
                   <p className="text-slate-500 text-sm leading-relaxed">
                    ...
                    amputation, heart attack, stroke, aortic aneurysm, pain or cramping while walking, OR a
                    family history of: aortic aneurysm, blood clot in legs or lungs, amputation, heart attack, stroke.
                  </p>
                </div>
                 ...
                 <div className="border-2 border-slate-200 rounded-xl p-5 hover:border-brand-red transition-colors bg-white">
                  ...
                  <p className="text-slate-700 font-medium mb-2">
                     With a history of <span className="text-brand-red font-bold">diabetes AND</span> a history any other following:
                  </p>
                   <p className="text-slate-500 text-sm leading-relaxed">
